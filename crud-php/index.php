 <!-- 
     membuat aplikasi CRUD dengan native PHP
 -->
...
<html lang="en">
  <head>
    ...
    <title>Aplikasi CRUD dengan Native-OOP </title>
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="index.php">
            <i class="glyphicon glyphicon-check"></i>
               CRUD Dengan Native PHP OOP dan MySQLi
          </a>
        </div>
      </div> <!-- /.container-fluid -->
    </nav>
